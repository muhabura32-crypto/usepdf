    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div>
                  <p className="text-lg font-medium text-gray-900 dark:text-white">
                    {isDragActive ? 'Drop your PNG files here' : 'Drag & drop your PNG files here'}
                  </p>
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500">
                  Supports PNG files up to 50MB each
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    {files.length} PNG image{files.length > 1 ? 's' : ''} converted to PDF
                  </p>
                </div>
                <a
                  href={downloadUrl}
        ...
        <div className="mt-16 pt-16 border-t border-gray-200 dark:border-gray-700">
          <ToolDescription
            title="Convert PNG to PDF: Preserve Transparency in Professional Documents"
            description="Convert your PNG images to PDF format while preserving transparency and image quality. Our PNG to PDF converter maintains alpha channels and creates professional PDF documents perfect for logos, graphics, and transparent images."
            features={[
              'Preserve PNG transparency (alpha channels)',
              'Convert multiple PNG images to a single PDF',
            ...
            howTo={[
              {
                ...
                description:
                  'Drag and drop multiple PNG files or click to browse. You can select multiple images to combine into one PDF.',
              },
              {
            ...
            faqs={[
              ...
              },
              {
                ...
                answer:
                  'Choose High for best quality and detail (recommended for graphics with transparency), Medium for balanced quality and file size, or Low for smaller files.',
              },
              {
              ...
              },
              {
                ...
                answer:
                  'We accept PNG files only. For other image formats like JPG, use our JPG to PDF converter.',
              },
            ]}
          />
        </div>
