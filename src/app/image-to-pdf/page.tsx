...
import { Image as ImageIcon, Download, Upload, ArrowLeft, CheckCircle, AlertCircle, Loader2 } from 'lucide-react'
...
export default function ImageToPDFPage() {
  ...
  const onDrop = useCallback((acceptedFiles: File[]) => {
    ...
    if (imageFiles.length === 0) {
      setError('Please upload image files (JPG, PNG, GIF, WebP, etc.)')
      return
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            >
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500">
                  Supports JPG, PNG, GIF, WebP, BMP, TIFF up to 50MB each
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-16 pt-16 border-t border-gray-200 dark:border-gray-700">
          <ToolDescription
            title="Convert Images to PDF: Universal Image to Document Converter"
            description="Convert any image format to PDF instantly. Our universal image converter supports JPG, PNG, GIF, WebP, BMP, TIFF and more. Perfect for converting photos, screenshots, graphics, and scanned documents into professional PDF files."
            features={[
              'Support for all major image formats (JPG, PNG, GIF, WebP, BMP, TIFF)',
              'Convert multiple images to a single PDF',
              'Preserve PNG transparency (alpha channels)',
            ...
            howTo={[
              {
                ...
                description:
                  'Drag and drop any image files or click to browse. We support JPG, PNG, GIF, WebP, BMP, TIFF and more.',
              },
              {
            ...
            faqs={[
              {
                ...
                answer:
                  'We support all major image formats including JPG, JPEG, PNG, GIF, WebP, BMP, and TIFF. Any image file that your browser can display should work.',
              },
              {
                question: 'Will PNG transparency be preserved?',
                answer:
                  'Yes! Our converter preserves PNG transparency (alpha channels) in the resulting PDF. Transparent backgrounds will remain transparent.',
              },
              {
              ...
              },
              {
                ...
                answer:
                  'Choose High for best quality and detail (recommended for important images), Medium for balanced quality and file size (most common), or Low for smaller files.',
              },
              {
